...
import me.rivaldev.mobsword.rivalmobswords.Main;
...
public class RivalMobSwordsCurrency extends CurrencyIntegration {
    private Main main;
    private EconomyManager manager;

    public RivalMobSwordsCurrency() {
        super("RivalMobSwords", null);
    }

    @Override
    public boolean canLoad() {
        return ClassUtils.INSTANCE.classExists("me.rivaldev.mobsword.rivalmobswords.Main");
    }
